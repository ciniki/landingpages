...
function ciniki_landingpages_pageHistory($ciniki) {
    ...
    $rc = ciniki_landingpages_checkAccess($ciniki, $args['tnid'], 'ciniki.landingpages.pageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.landingpages', 'ciniki_landingpage_history', $args['tnid'], 'ciniki_landingpages', $args['page_id'], $args['field']);
}
?>
