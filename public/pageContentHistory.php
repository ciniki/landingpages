...
function ciniki_landingpages_pageContentHistory($ciniki) {
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.landingpages', 'ciniki_landingpage_history', $args['business_id'], 'ciniki_landingpages', $args['content_id'], $args['field']);
}
?>
